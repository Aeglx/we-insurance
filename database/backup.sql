CREATE TABLE `business` (
  ...
  CONSTRAINT `business_ibfk_31` FOREIGN KEY (`agent_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_ibfk_32` FOREIGN KEY (`underwriter_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_ibfk_33` FOREIGN KEY (`insurance_id`) REFERENCES `insurance` (`id`) ON UPDATE CASCADE
