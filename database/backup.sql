CREATE TABLE `business` (
  ...
  CONSTRAINT `business_ibfk_185` FOREIGN KEY (`agent_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_ibfk_186` FOREIGN KEY (`underwriter_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_ibfk_187` FOREIGN KEY (`insurance_id`) REFERENCES `insurance` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_ibfk_188` FOREIGN KEY (`insurance_type_id`) REFERENCES `insurance_category` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `business_ibfk_189` FOREIGN KEY (`specific_insurance_id`) REFERENCES `insurance` (`id`)
